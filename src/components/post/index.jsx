            ...
            <div className={classNames('post', styles.wrapper)}>
                <Grid container spacing={2}>
                    <Grid item xs={12} sm={6} md={4}>
                        {image ? <img className={styles.poster} src={image} alt={title} /> : <></>}
                    </Grid>
                        ...
                        <div className={styles.inner}>
                            ...
                            {text_data && (
                                <div className={styles.info_wrapper}>
                                    <div className={styles.meta_wraper}>
                                        ...
                                        <div className={styles.roles}>
                                            ...
                                            <div className={styles.roles_list}>
                                                {roles?.map((r, i) => (
                                                    <div className={styles.roles_item} key={i}>
                                                        {r}
                                                    </div>
                                                ))}
                                    ...
                                    <div className={styles.description}>{text_data[0]}</div>
                        ...
                        <div className={styles.comments_list}>
                            ...
                            {postComments?.map((comment, index) => (
                                ...
                                >
                                    ...
                                    />
                                    <CardContent>
                                        <div className={styles.comment_text}>{comment?.text?.split('|')[0]}</div>
                                        <div className={styles.comment_rating}>
                                            <Rating
                                                max={10}
                                                value={+comment?.text?.split('|')[1]?.split(':')[1]}
                                                name="rating"
                                                readOnly
                                            />
                                        </div>
